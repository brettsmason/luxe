	...
	<footer class="entry__footer wrapper">
		<?php
			Hybrid\Post\display_terms(
				[
					'taxonomy' => 'category',
					'before'   => '<div class="entry__terms-wrapper">' . Luxe\fetch_svg( 'folder-open', [ 'title' => 'Categories:', 'class' => 'entry__terms-icon' ] ),
					'after'    => '</div>',
				]
			)
			?>
		...
		<?php
			Hybrid\Post\display_terms(
				[
					'taxonomy' => 'post_tag',
					'before'   => '<div class="entry__terms-wrapper">' . Luxe\fetch_svg( 'hashtag', [ 'title' => 'Tags:', 'class' => 'entry__terms-icon' ] ),
					'after'    => '</div>',
				]
			)
			?>
