...
Hybrid\Pagination\display(
	'posts', [
		...
		'next_text'  => '<span class="screen-reader-text">' . esc_html__( 'Next page', 'uuups' ) . '</span>' . Luxe\Svg\render( 'chevron-down', [ 'class' => 'pagination__anchor-icon pagination__anchor-icon--next' ] ),
